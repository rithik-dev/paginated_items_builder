...
typedef ShowLoaderOnResetGetter = bool Function(ItemsFetchScope itemsFetchScope);
...
typedef NoItemsWidgetBuilder = Widget Function(String? typeKey, VoidCallback refreshOnTap);

/// Defines the type [ErrorTextGetter].
typedef ErrorTextGetter = String Function(dynamic error);

/// Defines the type [ErrorWidgetBuilder].
typedef ErrorWidgetBuilder = Widget Function(dynamic error, VoidCallback refreshOnTap);
